...
# ==========================================
# 5. UI STYLING (FINAL COLOR FIXES)
# ==========================================
st.markdown("""
<style>
  ...
  /* --- HEADER ICONS FIX (TOP RIGHT & SIDEBAR TOGGLE) --- */
  
  /* 1. Header Action Icons (Share, Star, Edit, GitHub menu) */
  ...
  /* 2. Sidebar Collapse/Expand Button (The '>>' slider) */
  ...
  [data-testid="stHeader"] button[title="View app in Streamlit Cloud"] svg,
  [data-testid="stHeader"] button[title="Show menu"] svg {
      fill: white !important;
      color: white !important;
  }
